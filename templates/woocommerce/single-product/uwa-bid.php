...
<?php if(get_option('uwa_show_direct_bid', 'no') == 'yes'){ ?>
	...
	<form id="uwa_auction_form_direct"
		class="uwa_auction_form cart" method="post" enctype='multipart/form-data' 
		...
		<?php } else { ?>			
			...
			<button type="<?php echo $button; ?>" id="placebidbutton_direct"  class="bid_button button alt">
				<?php echo apply_filters('ultimate_woocommerce_auction_bid_button_text', $directbid_label, $product); ?>
			</button>
...
<?php if(get_option('uwa_show_custom_bid') == 'yes' || get_option('
	uwa_show_custom_bid') == false){ 
