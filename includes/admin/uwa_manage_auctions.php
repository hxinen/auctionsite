		...
		if (isset($_GET['page']) && $_GET['page'] = 'uwa_manage_auctions' && isset($_GET['users_auctions']) && $_GET['users_auctions'] == 'true') {
	    	...
	    	<ul class="subsubsub">
				<li><a href="?page=uwa_manage_auctions&auction_status=live" class="<?php echo $manage_auction_tab == 'live' ? 'current' : '';
                    ?>"><?php _e('Live Auctions', 'woo-ua');?></a> (<?php echo uwa_get_auctions_count('live');?>) |</li>
				<li><a href="?page=uwa_manage_auctions&auction_status=expired" class="<?php echo $manage_auction_tab == 'expired' ? 'current' : '';
                            ?>"><?php _e('Expired Auctions', 'woo-ua');?></a> (<?php echo uwa_get_auctions_count('expired');?>) |</li>

				<li><a href="?page=uwa_manage_auctions&auction_status=scheduled" class="<?php echo $manage_auction_tab == 'scheduled' ? 'current' : ''; ?>"><?php _e('Future Auctions', 'woo-ua');?></a> (<?php echo uwa_get_auctions_count('scheduled');?>)</li>
	    	</ul>
	    	<br class="clear">
